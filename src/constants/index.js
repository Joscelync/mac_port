            ...
            children: [
                {
                    ...
                    description: [
                        "Tech Stack:",
                        "React, Tailwind CSS, GSAP, JavaScript, Responsive Design Principles, Component-Based Architecture",
                        "Features: ",
                        "Reusable and scalable UI components, Smooth scroll-triggered animations and transitions, Interactive project showcases with modern visual storytelling, Dynamic layouts designed for both usability and visual impact",
                    ],
                },
                // {
                //     id: 2,
                ...
                },
                {
                    ...
                    fileType: "txt",
                    description: [
                        "This was honestly one of the most enjoyable projects I’ve worked on and it single-handedly reignited my passion for front-end development.",
                        "Since I hadn’t spent much time working in a React environment after my capstone project, I was initially intimidated by how layered and interactive this build was. However, working through the challenges pushed me to deepen both my technical understanding and confidence as a developer, ultimately motivating me to continue advancing my skills in web development.", "A large portion of my learning actually happened after the initial build was complete, when I began customizing the project. Diving deeper into the React architecture while working alongside Tailwind CSS gave me a much stronger understanding of component-based design, reusable patterns, and how utility-first styling can streamline development when structured intentionally. I especially enjoyed dissecting the window control system and understanding how reusable higher-order components could manage functionality, state, and visual consistency across the interface.",
                        "As someone who naturally leans a bit maximalist in design, one of the most rewarding challenges was learning how to balance strong visual aesthetics with usability and responsiveness. I had a lot of fun experimenting with typography, motion, and interactive details  particularly exploring dynamic fonts and hover interactions that helped make the experience feel more immersive and alive without sacrificing clarity or performance."
],
